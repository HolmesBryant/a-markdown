...
export default class AMarkdown extends HTMLElement {
  ...
  */
  connectedCallback() {
    ...
    if (this.debug) {
      this.#doDebug('connectedCallback');
    }
  ...
  */
  #displayError(message) {
    ...
    if (this.debug) {
      this.#doDebug(`displayError( ${message} )`);
      console.trace('trace: displayError()');
    }
  ...
  */
  ...
  async #init() {
    ...
    if (!this.#file) {
        ...
        if (this.debug) this.#doDebug('init()');
        return;
    }
  ...
  */
  async #render() {
    ...
    if (this.debug) this.#doDebug('render()');
  }
  ...
  #setMutationObserver() {
    const callback = () => {
      if (!this.hasAttribute('file')) {
        if (this.debug) {
          console.groupCollapsed('mutationObserver callback textContent');
            console.trace('textContent', this.textContent);
            console.groupEnd();
          this.#doDebug('mutationObserver callback');
        }
        // this.#init();
      }
    };
    ...
    if (this.debug) this.#doDebug('setMutationObserver()');
  }
